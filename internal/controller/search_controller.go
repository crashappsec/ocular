...
func (r *SearchReconciler) newSearchPod(search *v1beta1.Search, crawlerSpec v1beta1.CrawlerSpec, sa *corev1.ServiceAccount, containerOpts ...containers.Option) (*corev1.Pod, error) {
	...
	sidecarContainer := r.generateSidecarContainer(search)
	...
	pod := &corev1.Pod{
		...
		Spec: corev1.PodSpec{
			...
			InitContainers:     containers.ApplyOptions([]corev1.Container{sidecarContainer}, containerOpts...),
			Containers:         containers.ApplyOptions([]corev1.Container{crawlerSpec.Container}, containerOpts...),
